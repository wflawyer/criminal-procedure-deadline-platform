...
export function toDateTimeLocalKey(date: Date): string {
...
export function getDefaultInputs(today = new Date()): CaseInputs {
  return {
    caseName: "新建刑事案件", perspective: "victimAgent", caseRoute: "public", asOf: toDateTimeLocalKey(today), optionalProcedures: [], incidentDate: "", reportDate: "", acceptedAt: "",
